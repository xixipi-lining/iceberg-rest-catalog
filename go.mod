module github.com/xixipi-lining/iceberg-rest-catalog

go 1.24.4

replace github.com/apache/iceberg-go => github.com/xixipi-lining/iceberg-go v0.0.0-20250821085713-e24cba37b304
